      ...
      <div className="antialiased font-sans h-screen overflow-y-auto  bg-gray-50">
        <div className="container pt-4 mx-auto px-4 sm:px-8">
          ...
          <div className="flex items-center mb-3 flex-col">
            ...
            <p className="text-3xl text-red-400 mb-10  mt-2 font-bold">
              STUDENTS
            </p>
          </div>
          ...
          <div className="py-8">
            ...
            >
              <span className="text-green-600 rounded">Active</span> Students
            </h2>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-5  border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">2003</p>
                      </td>
                      <td className="px-5  border-b border-gray-200 bg-white text-sm">
          ...
          <div className="py-8">
            ...
            >
              <span className="text-rose-600 rounded">Rejected</span> Students
            </h2>
            <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4  overflow-x-auto">
              <div className="inline-block min-w-full shadow mr-4 rounded-lg overflow-x-auto">
                <table className="min-w-full leading-normal">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-5  border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">Renu</p>
                      </td>
                      <td className="px-5  border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                          nirmala123@gmail.com
